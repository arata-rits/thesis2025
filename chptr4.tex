...
撮影した画像を以下に示す.画像はそれぞれ，撮影距離20cm, 撮影距離40cm, 撮影距離60cm, 撮影距離80cmを表している．

\begin{figure}[H]
	\centering
	\includegraphics[width=1.0\linewidth]{pics/dist20.png}
	\caption{距離20cmから撮影したときの画像}
	\label{fig:dist20}
\end{figure}
...
膨張処理前の画像と膨張処理後の画像は下図のとおりである(図\ref{fig:before_dilation}), (図\ref{fig:after_dilation})．
