...
ステゴパネル(Stego-panel)とは，画像や音声などのデータに秘密情報を埋め込む情報秘匿技術の一種であるステガノグラフィー(Steganography)と，照明パネル(Panel)を組み合わせた造語である．ステゴパネルは，カメラで撮影することで，肉眼では視認できない情報を取得することが可能となる(図\ref{fig:stego_eye}, 図\ref{fig:stego_camera})
